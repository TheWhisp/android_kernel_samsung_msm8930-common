...
#if !defined(CONFIG_MACH_SERRANO) && !defined(CONFIG_MACH_GOLDEN_VZW) && !defined(CONFIG_MACH_LT02)&& !defined(CONFIG_MACH_GOLDEN_ATT) && !defined(CONFIG_MACH_WILCOX_EUR_LTE) && !defined(CONFIG_MACH_COMANCHE) && !defined(CONFIG_MACH_LOGANRE)
