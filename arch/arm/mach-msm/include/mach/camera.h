...
enum msm_bus_perf_setting {
	...
	S_DUAL,
	S_LOW_POWER,
#if defined(CONFIG_MACH_MELIUS) || defined(CONFIG_MACH_SERRANO)  || defined(CONFIG_MACH_GOLDEN) || defined(CONFIG_MACH_LT02) || defined(CONFIG_MACH_CANE) || defined(CONFIG_MACH_LOGANRE)
